...
public class AppController {
    ...
    public ModelAndView login(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
        ModelAndView model = new ModelAndView();
//        if (new LoginService().check("Urvashi", "test")) {
//        	model.addObject("title", "Database connected!");
//        } else {
//        	model.addObject("title", "Bad luck, Try Again...");
//        }       
    ...
    public ModelAndView usermgmt(Authentication authentication) {
